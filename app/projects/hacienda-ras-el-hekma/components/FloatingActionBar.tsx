...
export function FloatingActionBar() {
  return (
    <motion.div
      ...
      className="ph-sticky-mobile fixed bottom-0 left-0 right-0 z-50 md:hidden"
      aria-label="إجراءات سريعة"
    >
      <div className="ph-sticky-online" aria-live="polite">
        <span className="dot" aria-hidden="true" />
        <span className="text">فريق السيلز متاح الآن</span>
        <span className="mono">رد خلال ٥ دقايق</span>
      </div>

      <div className="ph-sticky-mobile-inner">
        <div className="ph-sticky-mobile-row">
          <a
            href={CALL_HREF}
            className="ph-sticky-call"
            aria-label="اتصل بنا"
          >
            <svg
              viewBox="0 0 24 24"
