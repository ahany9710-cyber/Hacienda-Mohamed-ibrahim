...
export function Header() {
  return (
    <header className="header" role="banner">
      <div className="wrap">
        <a href="#hero" className="brand" aria-label={HACIENDA.projectName}>
          <span className="brand-mark" aria-hidden="true">
            <Image
              src="/hacienda/logos/palm-hills-mark-icon.png"
              alt=""
              width={38}
              height={38}
              priority
          ...
          <span className="brand-text">
            <span className="brand-project" lang="en">
        ...
        <div className="header-actions">
          ...
          >
            ...
            <span className="label-text">تواصل واتساب</span>
          </a>
          <a
          ...
          >
            ...
            <span className="label call-label">اتصل بنا</span>
          </a>
          <Link href="/en" className="lang-toggle" aria-label="تبديل اللغة">
